...
import com.nipa.healthcaremobile.databinding.FragmentClientDashboardBinding
...
class ClientDashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonLogoutClient.setOnClickListener {
            auth.signOut()
            // Ensure fragment is still added before navigating
            if (isAdded) {
                findNavController().navigate(R.id.action_client_logout)
            }
        }

        // TODO: Implement other button click listeners (view notifications, etc.)
    }
